                            ...
                            <ul class="list-inline">
                                ...
                                <li class="language list-inline-item">
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul>
                                               <li><a href="#" class="current"><img src="public/images/icons/en-gb.png" alt="Icons"> English</a></li>
                                               <li><a href="#"><img src="public/images/icons/fr-fr.png" alt="Icons"> Français</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
